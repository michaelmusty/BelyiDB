    ...
    if (s`BelyiDBType eq "Hyperbolic") and BelyiMapIsComputed(s) then
      ...
      for i := 1 to #gal_orbs do
        ...
        if compile then
          ...
          pdfCropPath := Sprintf("~/github/BelyiDB/portraits/%o/%o/%o-crop.pdf", d, name, IntegerToLetter(i));
          pngPath := Sprintf("~/github/BelyiDB/portraits/%o/%o/%o.png", d, name, IntegerToLetter(i));
